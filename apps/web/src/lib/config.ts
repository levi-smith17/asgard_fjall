export const CAIRN_API_URL =
  import.meta.env.VITE_CAIRN_API_URL?.trim() || 'https://api.asgard.levismith.us'

/** Prod Cairn web client (public SPA ids — safe to bake in until asgard Cognito cutover). */

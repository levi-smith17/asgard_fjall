...
import { z } from 'zod'
import { saveResource } from '@/lib/cairn-starfield-api'
...
import { ResourcePicker } from '@/components/core/ui/resource-picker'
...
export function ResourceForm({ resource, resources, onDone, onRefresh, onDelete }: ResourceFormProps) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <InspectorFormActions
        ...
        showDelete={!!resource?.id && !!onDelete}
        onDelete={onDelete}
      />
    </div>
  )

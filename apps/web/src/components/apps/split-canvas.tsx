...
export function AppSplitCanvas({ showDetail, list, detail }: { showDetail: boolean; list: React.ReactNode; detail?: React.ReactNode }) {
  return (
...
export function AppPanelHeader({ title, actions }: { title: string; actions?: React.ReactNode }) {
  return (

...
// Companion media (Ordstirr) — public bucket behind media.asgard.levismith.us.
export const PUBLIC_MEDIA_BUCKET = process.env.S3_PUBLIC_MEDIA_BUCKET ?? 'asgard-fjall-prod-public-media'

// Media CloudFront base URL (companions/*).
export const MEDIA_CDN_URL = process.env.MEDIA_CDN_URL ?? 'https://media.asgard.levismith.us'
